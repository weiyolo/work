...
void forward() {
  DCMotor_1->setSpeed(200+9);
  DCMotor_1->run(FORWARD);
  DCMotor_2->setSpeed(200-8);
  DCMotor_2->run(FORWARD);
  DCMotor_3->setSpeed(200+9);
  DCMotor_3->run(FORWARD);
  DCMotor_4->setSpeed(200+6);
  DCMotor_4->run(FORWARD);
}

void turnLeft() {
  DCMotor_1->setSpeed(200+6);
  DCMotor_1->run(BACKWARD);
  DCMotor_2->setSpeed(200-7);
  DCMotor_2->run(BACKWARD);
  DCMotor_3->setSpeed(200-7);
  DCMotor_3->run(FORWARD);
  DCMotor_4->setSpeed(200-8);
  DCMotor_4->run(FORWARD);
}

void turnRight() {
  DCMotor_1->setSpeed(200-1);
  DCMotor_1->run(FORWARD);
  DCMotor_2->setSpeed(200-1);
  DCMotor_2->run(FORWARD);
  DCMotor_3->setSpeed(200+2);
  DCMotor_3->run(BACKWARD);
  DCMotor_4->setSpeed(200+2);
  DCMotor_4->run(BACKWARD);
}

void moveLeft() {
  DCMotor_1->setSpeed(200+3);
  DCMotor_1->run(BACKWARD);
  DCMotor_2->setSpeed(200+3);
  DCMotor_2->run(FORWARD);
  DCMotor_3->setSpeed(200-2);
  DCMotor_3->run(BACKWARD);
  DCMotor_4->setSpeed(200-2);
...
void moveRight() {
  DCMotor_1->setSpeed(200-2);
  DCMotor_1->run(FORWARD);
  DCMotor_2->setSpeed(200-2);
  DCMotor_2->run(BACKWARD);
  DCMotor_3->setSpeed(200+3);
  DCMotor_3->run(FORWARD);
  DCMotor_4->setSpeed(200+1);
  DCMotor_4->run(BACKWARD);
}
